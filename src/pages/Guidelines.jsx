...
function Guidelines() {
  return (
    <div className="py-12">
      {" "}
      <Container>
        <h1 className="text-3xl font-bold mb-6">Posting Guidelines</h1>

        <p className="mb-6">
          (ThinkNest — Learn Smart, Score Better) This platform is a study notes
          sharing website. Please upload only educational and learning related
          content so that students can learn easily from your notes.
        </p>
        ...
        <p className="mt-6 text-gray-500">
          Posts not related to education may be removed to maintain quality of
          the platform.
        </p>
        <button>
          <Link
            to="/"
            className=" ml-1 font-medium text-blue-500 hover:text-blue-700 mb-6 inline-block"
          >
